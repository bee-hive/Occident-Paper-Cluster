...
well = args.well
print(wells[well])
B3 = load_data_local('./updated_full/cart_' + wells[well] + '_start_0_end_350_nuc_15_cyto_75.zip')

ts = B3['y'][1][lower_lim:upper_lim,:,0,:]
...
np.save('./centroid-arrays/' + wells[well] + '-cancer-cells', centroids)
print(time.time() - T0)